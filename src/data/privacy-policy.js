const privacyPolicies = {
  data: {
    heading: `Privacy Policy of<br /> Speedway Flight Training Scholarship Fund.`,
    subheading: `Last updated: 27/05/2025`,
    content: [
      {
        heading: "Introduction",
        paragraphs: [
          "Speedway Flight Training Scholarship Fund. operates the https://speedwayscholarship.com/ website. This page is used to inform website visitors regarding our policies on the collection, use, and disclosure of Personal Information for users who interact with our website or services.",
      ...
      },
      {
        ...
        paragraphs: [
          "Our website may include links to other websites not operated by Speedway Flight Training Scholarship Fund.. We advise you to review the privacy policies of these third-party sites. We are not responsible for the content or privacy practices of any external services.",
        ],
      },
      {
